...
struct Challenge: Hashable, Codable, Identifiable {
    ...
    var localChallenge: LocalChallenge {
        var tempLocalChallenge = LocalChallenge(challengeId: id, creator: creator, mateList: mateList, challengeTitle: challengeTitle, createdAt: createdAt, createdDate: createdDate, count: count, isChecked: isChecked, isChallengeAlarmOn: false)
